<html>
  <body>
    <form method="post" action="slip No 15.php">
      <h1> Grocery Items </h1>
      
      Product: 
      Sugar (40 Rs/Kg)
      <input type="checkbox" name="c1" value="sugar"> Select Product
      Enter Quantity: <input type="text" name="t1"><br>
      
      Product: 
      Oil (140 Rs/Kg)
      <input type="checkbox" name="c2" value="oil"> Select Product
      Enter Quantity: <input type="text" name="t2"><br>

      Product: 
      Camel (100 Rs/Kg)
      <input type="checkbox" name="c3" value="camel"> Select Product
